  ...
  return (
    <View className="flex-1 mx-4 py-4">
      <FlatList
        ...
        renderItem={({ item }) => (
          <View className="items-center justify-between p-4 border-border/20 bg-white my-2 rounded-lg">
            ...
            <Text className="leading-6 mt-4" numberOfLines={5}>Mô tả: {item?.description}</Text>
          </View>
        )}
      />
    </View>
