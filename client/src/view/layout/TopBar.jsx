...
export const TopBar = (props) => {
  ...
  return (
    <div className="fixed top-0 inset-x-0 px-6 z-10">
      <div className={`h-14 transition-all duration-500 ease-in-out ${showSidebar ? 'lg:ml-[18rem]' : ''}`}>
        <div className="flex justify-between items-center h-full">
          <Buttonz onClick={() => setShowSidebar(!showSidebar)} className="!p-0" icon={<Bars3Icon className="w-8 stroke-1" />} />
